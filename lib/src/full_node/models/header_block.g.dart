...
HeaderBlock _$HeaderBlockFromJson(Map<String, dynamic> json) {
  return HeaderBlock(
    ...
    (json['transactions_filter'] as List<dynamic>)
        .map((e) => e as int)
        .toList(),
...
Map<String, dynamic> _$HeaderBlockToJson(HeaderBlock instance) =>
    <String, dynamic>{
